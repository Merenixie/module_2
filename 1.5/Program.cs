...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Создаем объект термостата с порогом в 25°C
        ...
        sensor.CurrentTemperature = -210;  // Температура ниже порога — включение отопления
        sensor.CurrentTemperature = 456;  // Температура выше порога — выключение отопления
    }
}
