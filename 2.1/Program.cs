...
class Program
{
    static void Main(string[] args)
    {
        ...
        BankAccount account1 = new BankAccount("576937815", "Джастин Бибер", 5000m);
        BankAccount account2 = new BankAccount("304724568", "Элвис Пресли", 10000m);
        ...
        account1.Withdraw(7000m); // Недостаточно средств
        account2.Deposit(23000m);
        account2.Withdraw(4000m);
